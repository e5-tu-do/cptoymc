...
int main(int argc, char * argv[]){
  ...
  RooExtendPdf            pdfBkgYield_Combo("pdfBkgYield_Combo","pdfBkgYield_Combo",pdfBkg_Combo,parBkgYield_Combo);
