...
BSig_CPV_P2VP_Generator::BSig_CPV_P2VP_Generator() :
  ...
  comp_cat_(-1000),
  tag_calib_func_omegaOS_([](double eta) -> double { return eta; } ),
  tag_calib_func_domegaOS_([](double eta) -> double { return 0.; } ),
  tag_calib_func_omegaSS_([](double eta) -> double { return eta; } ),
  tag_calib_func_domegaSS_([](double eta) -> double { return 0.; } )
{
